...
// import MicOnIcon from '../../assets/micOn'
// import MicOffIcon from '../../assets/micOff'
...
//   const textInput = input + transcript ;
//   return (
...
//         />
//         {listening ? 
//           <div className='hover:cursor-pointer mt-6' onClick={SpeechRecognition.stopListening}>
//             <MicOnIcon /> 
//           </div> :
//           <div className='hover:cursor-pointer mt-6' onClick={SpeechRecognition.startListening}>
//             <MicOffIcon />
//           </div>
